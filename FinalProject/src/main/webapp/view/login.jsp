...
<fmt:setBundle basename="locale"/>
	...
	<div class="content">
		...
		<div class="login_wrapper">
			<br> <br>
			<h3 class="form_header">To enter the system pass the login form</h3>
			<br>
			<form action="/FinalProject/auth" method="post" class="center_form">
				<label>Login</label><br> <input type="text" value="client"
					name="login" required><br> <br> <label>Password</label><br>
				<input type="password" value="client" name="pass" required
					align="left"><br> <br> <input type="submit"
					value="Login" class="ref_button"><br> <br> <a
					href="/FinalProject/main" class="ref_button">Home</a>
			</form>
