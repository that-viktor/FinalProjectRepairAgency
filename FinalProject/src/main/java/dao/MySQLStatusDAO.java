...
/**
 * MySQLStatusDAO class provides API for manipulating DB entity REC_STATUS like Java
 * objects
 * 
 * @author Viktor
 *
...
public class MySQLStatusDAO {
	...
	private static final Logger logger = LogManager.getLogger(MySQLStatusDAO.class);
